...
if __name__ == "__main__":
    ...
    for episode in range(num_training_episodes):
        ...
        # altr model is only run once out here, and path from model is used 
        if TEST_SETTINGS['model_selection'] == 'altr':
        ...
        for step in range(episode_length):
            ...
            # 'attention learn to route' model code
            if TEST_SETTINGS['model_selection'] == 'altr':
                _log_ps = log_ps.clone()
                ...
                features = _log_ps # set features for value branch later
